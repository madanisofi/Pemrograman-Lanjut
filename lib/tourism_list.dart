...
class _TourismListState extends State<TourismList> {
  final List<TourismPlace> tourismPlaceList = [
    TourismPlace(
      ...
      price: 'IDR 20.000',
      description:
          '''Heha Sky View atau disingkat HSV merupakan sebuah destinasi wisata baru yang terletak di Gunung Kidul atau kurang lebih 25 menit dari Kota Yogyakarta jika ditempuh saat lalu lintas normal. Lokasinya berada di Jalan Dlingo - Patuk No. 2, Patuk, Gunung Kidul, Daerah Istimewa Yogyakarta. Heha Sky View adalah sebuah tempat makan yang terletak di perbukitan dan menawarkan view panorama alam Yogyakarta yang begitu indah. Kemudian di desain sedemikian rupa agar terlihat lebih menarik. Dari hal itu, Heha Sky View bisa dijadikan tempat untuk melihat pemandangan kota indah Kota Yogyakarta dengan view paling baik karena hampir keseluruhan sudut kotanya terlihat sempurna.''',
    ),
    TourismPlace(
